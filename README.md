...
> If you see `import pkg_resources` errors on Ubuntu/Python 3.12, reinstall packaging tools in the venv:
> ```bash
> /opt/highrise-bot/.venv/bin/pip install --upgrade pip setuptools wheel
> sudo systemctl restart highrise-bot.service
> ```
